...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3); _sage_const_8 = Integer(8); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10); _sage_const_5 = Integer(5)
...
TT = CombinatorialTheory("123_graph_link_no_C5-", test_generate, test_identify, edges=_sage_const_2 , C0=_sage_const_1 , C1=_sage_const_1 , C2=_sage_const_1 )
...
# Optimize
TT.optimize(B - M*_sage_const_9 /_sage_const_10 , _sage_const_5 , maximize=True, positives = positives, exact=True)
