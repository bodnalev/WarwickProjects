...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_6 = Integer(6); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_50 = Integer(50)
...
positives = [edge_12 - edge_01, point - _sage_const_1 /_sage_const_3 , point2 - _sage_const_2 /_sage_const_3 ]
...
# Optimize (correct?)
x = TT.optimize(B - _sage_const_1 /_sage_const_2  * M, _sage_const_5 , maximize=True, positives = positives, certificate = True)
print(x[_sage_const_1 ][:_sage_const_50 ])
